...
class Practica3ApplicationTests {
	...
	public class BaseDatosConDatos {
        ...
        public void cogeDietaConcretaCorrectamente() throws JsonProcessingException {
            ...
            assertThat(respuesta.getBody().getNombre().equals("Musculos"));
		...
		public void actualizaDietaCorrectamente() throws JsonProcessingException {
			var peticionUsuario = "http://localhost:" + portGestionUsuarios + "/usuario";
			HttpHeaders headers = new HttpHeaders();
			headers.set("Authorization", "Bearer " + token);
			...
			DietaDTO dietaActualizada = new DietaDTO(1L, "Musculos Actualizada", "Dieta para ganar músculo actualizada");
			...
			assertThat(respuesta.getBody().getNombre()).isEqualTo("Musculos Actualizada");
		}
